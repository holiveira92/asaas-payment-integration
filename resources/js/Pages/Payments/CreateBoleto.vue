<template>
    <Layout>
        ...
        <template #header>
            <h2 class="font-semibold text-xl leading-tight">Pagamento por Boleto</h2>
        </template>
        ...
        <div class="py-12">
            ...
            <div class="max-w-xl sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-8">
                        ...
                        <!-- DATA DE VENCIMENTO -->
                        <div class="mb-4 ">
                            <label for="due_date" class="block text-white">Data de Vencimento:</label>
                            <input type="date" id="due_date" v-model="form.due_date" class="form-input" required/>
                        </div>
            ...
            await axios
                .post(route('api.payments.process'),
                {
                    ...
                    "payment": {
                        ...
                        "method_id": "aa4c157a-670d-429b-b0ea-20b6ff09886b",
                    }
                })
                .then(response => {
                    this.loading = true;
